#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Generate 2013 stamp md files in 2024 standard format."""

import os, json

BASE = r"G:\微云同步文件夹\邮票网站\新中国邮票图片全集（1949年-2026年最新）\40-编年号2013年"
...
data_file = os.path.join(os.path.dirname(__file__), "gen_2013_data.json")
